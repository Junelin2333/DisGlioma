...
from utils.transform import clinical_variable_token_list, mapping_dict, description_indices, CLS_TOKEN_OFFSET

def init_language_features():
    model_key = "emilyalsentzer/Bio_ClinicalBERT"
