...
if __name__ == '__main__':
    ...
    ds_train = RNASeqDataset(args.root_dir,args.ds_name,mode='all', fold=args.fold)
    ds_valid = RNASeqDataset(args.root_dir,args.ds_name,mode='test', fold=args.fold)
    ...
    model_ckpt = ModelCheckpoint(
        ...
        filename="disgene_fold{}".format(args.fold),
        monitor='val_loss',
        save_top_k=1,
        mode='min',
        verbose=True,
